...
public class GroupJoinAdapter extends RecyclerView.Adapter<GroupJoinAdapter.GroupHolder> {
    private ArrayList<String> mGroupList;
    private Context mContext;

    public GroupJoinAdapter(Context context, ArrayList<String> groupList) {
        mContext = context;
            ...
            groupButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(Home_Activity.user.getGroupNames().contains(groupName)){
                         intent = new Intent(mContext, Chat_Activity.class);
                    }else{
                     intent = new Intent(mContext, Group_Select.class);}
